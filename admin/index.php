            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-table"></i> <span>Data Tentor</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="index.php?id=tentor_input_data"><i class="fa fa-angle-double-right"></i> Input Data</a></li>
                                <li><a href="index.php?id=tentor_lihat_data"><i class="fa fa-angle-double-right"></i> Lihat Data</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="index.php?id=siswa_input_data"><i class="fa fa-angle-double-right"></i> Input Data</a></li>
                                <li><a href="index.php?id=siswa_lihat_data"><i class="fa fa-angle-double-right"></i> Lihat Data</a></li>
                            </ul>
                        </li>
                        <li>
