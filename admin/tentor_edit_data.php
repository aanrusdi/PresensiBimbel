...
$sql="select * from tentor where id_tentor='$no'";
...
?>
	<div class="container">
		...
		<h2 class="text-center text-info"> Edit Data Tentor</h2></br></br>
			<form  method="POST" action="index.php?id=tentor_edit_data_proses&no=<?php echo $row['id_tentor']; ?>" >
